...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		Priduct laundry = new Priduct("동돌이",450000,8);
		...
		System.out.println(laundry.getName() + "판매가 : " + laundry.calculateDiscontPrice() + "원");
		System.out.println(cinema.getName() + "판매가 : " + cinema.calculateDiscontPrice() + "원");
